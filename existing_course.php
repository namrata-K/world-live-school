  ...
  if($DataRow)
      {
      	...
      	$query = "INSERT INTO content (tag1,tag2,tag3,tag4,tag5,topic,course_id,content_name,description,content_type,s_no) VALUES('$tag1', '$tag2', '$tag3', '$tag4', '$tag5', '$t_name', '$cid', '$file_name', '$desc', '$c_type', '$s_no')";
      	$Execute = mysqli_query($Connection, $query);
      	if($Execute)
      			{?>

<?php
  ...
  $id = 1;
  $id = $id + $DataRow['mcid']; 
  $query = "INSERT INTO course (course_name,thumbnail,level,subject,teacher_id,rating,description, course_id) VALUES('$c_name', '$file_name', 0, 'NA', '$teacher_id', 0 , '$desc', '$id')";
    $Execute = mysqli_query($Connection, $query);
    if($Execute)

...
<section class="wrap-whole">
             <section class="container__main">      
                <header class="container__header">
                    ...
                    <a href="classroomVideo.php" class="activee">VIDEOS</a>
  ...
  <tr>
    ...
    <th style="padding: 3%" ><video width="320" height="240" controls>
  ...
  <tr>
    ...
    <td style="padding: 3%"><video width="320" height="240" controls>
  <source src="movie.mp4" type="video/mp4">
  <source src="movie.ogg" type="video/ogg">
  </video></td>
    <td style="padding: 3%"><video width="320" height="240" controls>
